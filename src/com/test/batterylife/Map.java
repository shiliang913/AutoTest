...
public class Map extends Operation {
	...
	public void running(int n) throws IOException, UiObjectNotFoundException, RemoteException{
		try {
			...
			clickExist(findViewById("com.baidu.BaiduMap:id/guide_button_close"));//关闭向导
			sleep(2000);
			...
			findViewByText("tcl大厦").waitForExists(20000);
			click("tcl大厦");
			sleep(2000);
			...
			findViewByText("欢乐谷").waitForExists(20000);
			click("欢乐谷");
			findViewByText("跟我走").waitForExists(10000);
			click("跟我走");
			clickExist("接受");
